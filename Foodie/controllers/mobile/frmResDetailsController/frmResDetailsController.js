define({
   ...
   ************************************************************************************/
    onNavigate: function(restaurantParameter) {
      ...
      var custmetrics2=[{"selected restaurent":restaurant["name"]}];
      KNYMetricsService.sendCustomMetrics("frmResDetails",custmetrics2);
   ...
   *************************************************************************/
      ...
      function successCB(dataModel){
        ...
        restaurant["SoftDeleteFlag"] = false;
        resDataObject.setRecord(restaurant);
    	dataModel.create({
        	dataObject: resDataObject
    	}, function(successResponse){
          
      var custmetrics2=[{"Marked as favourite":restaurant["name"]}];
      KNYMetricsService.sendCustomMetrics("frmResDetails",custmetrics2);
      KNYMetricsService.flushEvents();
