/*
 * Model class for NearByRestaurant object under NearByRestaurant object service group
 ...
 */
kony.model.NearByRestaurant.NearByRestaurantModel = (function(){
	
    function NearByRestaurantModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(NearByRestaurantModel,kony.model.BaseModel);
    /**
     * This method returns requested property of column from metadata.
     * @memberof NearByRestaurantModel#
     * @param {String} columnName - Column Name.
     * @param {String} key - property of column.
     * @returns {Object} - Value for property 
     */
    NearByRestaurantModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    NearByRestaurantModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    NearByRestaurantModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    NearByRestaurantModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    NearByRestaurantModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    NearByRestaurantModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    NearByRestaurantModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    NearByRestaurantModel.prototype.validate = function(dataObject, validationType) {
