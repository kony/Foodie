/*
 * Model class for Restaurant object under FavouriteRestaurant object service group
...
kony.model.FavouriteRestaurant = kony.model.FavouriteRestaurant || {};
 ...
 */
kony.model.FavouriteRestaurant.RestaurantModel = (function(){
	
    function RestaurantModel(applicationContext, entityMetaData, configOptions) {
    	/**
	...
	inheritsFrom(RestaurantModel,kony.model.BaseModel);
    /**
     ...
     */
    RestaurantModel.prototype.getValueForColumnProperty = function(columnName, key) {
     ...
     */
    RestaurantModel.prototype.getColumnNames = function() {
     ...
     * @returns {Object} - Value for property 
     */
    RestaurantModel.prototype.getValueForProperty = function(propertyName){
     ...
     */
    RestaurantModel.prototype.getColumnInfo = function(columnName) {
     ...
     */
    RestaurantModel.prototype.getFieldPickListValues = function(columnName){
     ...
     */
    RestaurantModel.prototype.fetchDataForColumns = function(columnNames, onSuccess, onError, dataModel) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.fetch = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.create = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.update = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.partialUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.completeUpdate = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.remove = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.removeByPrimaryKey = function(primaryKeyValueMap, onSuccess, onError){
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.fetchResponse = function(options, onSuccess, onError) {
     ...
     * @param {SuccessCallback} onError - Error Callback.
     */
    RestaurantModel.prototype.customVerb = function(verbName, options, success, error) {
     ...
     */
    RestaurantModel.prototype.validate = function(dataObject, validationType) {
