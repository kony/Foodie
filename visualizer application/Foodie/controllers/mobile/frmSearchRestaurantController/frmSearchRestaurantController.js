 ...
 //Type your controller code here 
  ...
  searchRestaurant:function(){
    ...
    try{
      ...
      var intgService;
      	intgService = client.getIntegrationService("Restauants");
		intgService.invokeOperation("getRestaurants",
  ...
  loadCuisines:function(){
    ...
    try{
      	...
      	intgService = client.getIntegrationService("Restauants");
		intgService.invokeOperation("getCuisines",
             {"user-key":"de7c3b6703285fcd9c6d2e6c61eca6ee"},
             {"city_id":cityId},
              function(response){
  ...
  getCity:function(){
    ...
    try{
      	intgService = client.getIntegrationService("Restauants");
		intgService.invokeOperation("getCity",
             {"user-key":"de7c3b6703285fcd9c6d2e6c61eca6ee"},
